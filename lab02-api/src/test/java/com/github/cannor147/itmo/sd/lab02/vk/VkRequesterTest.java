...
public class VkRequesterTest {
    ...
    public void init() {
        ...
        this.vkRequester = new VkRequesterImpl(vkApiClient, userActor);
    }
    ...
    public void testCount() throws ClientException, ApiException {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            assertThat(vkRequester.count("#tiktok", new Date(), new Date())).isEqualTo(result);
        }
    }
}
